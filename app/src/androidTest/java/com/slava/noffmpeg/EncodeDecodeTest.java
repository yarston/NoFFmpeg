...
public class EncodeDecodeTest {
    public static final String TAG = "EncodeDecodeTest";
    ...
    private void encodeDecodeVideoFromBuffer(boolean toSurface) throws Exception {
        ...
        try {
            ...
            doEncodeDecodeVideoFromBuffer(encoder, colorFormat, decoder);
        } finally {
    ...
    private static void assertEquals(String s, long a, long b) {}
    ...
    public static void checkColorFormats() {
            ...
            for (int j = 0; j < types.length; j++) {
                if (types[j].equalsIgnoreCase(mimeType)) {
                    ...
                    for (int k = 0; k < capabilities.colorFormats.length; k++) {
                        ...
                        Log.v(TAG, "support color format: " + colorFormat + " match: " + isRecognizedFormat(colorFormat));
                    }
                }
            }
        }
